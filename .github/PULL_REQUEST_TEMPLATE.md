...
- [ ] Tests added or updated for the change; no test touches the real `HOME`, spawns a real engine outside a sandbox, starts a real Tailscale node or calls the real service manager
